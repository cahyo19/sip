                ...
                <div class="col-md-6">
                  <div class="form-group"> 
                    <?php 
                      ...
                      echo form_dropdown('category_id', $categories, isset($inputs['category_id']), ['class' => 'form-control']); 
                    ?>
                  </div>
                  <div class="form-group">
                    <?php 
                      ...
                      $product_name = [
                        ...
                        'name'  => 'product_name',
                        'id'    => 'product_name',
                        'value' => isset($inputs['product_name']),
                        'class' => 'form-control',
                  ...
                  <div class="form-group">
                    <?php 
                      ...
                      $product_price = [
                        ...
                        'name'  => 'product_price',
                        'id'    => 'product_price',
                        'value' => isset($inputs['product_price']),
                        'class' => 'form-control',
                        'placeholder' => '0'
                      ];
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <?php 
                      ...
                      echo form_dropdown('product_status', ['' => 'Pilih', 'Active' => 'Active', 'Inactive' => 'Inactive'], isset($inputs['product_status']), ['class' => 'form-control']); 
                    ?>
                  </div>
                  <div class="form-group">
                    <?php 
                  ...
                  <div class="form-group">
                    <?php 
                      ...
                      $product_desc = [
                        ...
                        'value' => isset($inputs['product_description']),
                        'class' => 'form-control',
